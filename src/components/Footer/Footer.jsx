			...
			<footer className="bg-gray-900 text-white pt-12">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="grid grid-cols-1 gap-10 pb-10 md:grid-cols-2 lg:grid-cols-4">
						...
						<div>
							<h3 className="text-lg font-semibold text-white mb-4 border-b-2 border-indigo-500 inline-block pb-1">
								Quick Links
							</h3>
							<nav className="space-y-2">
								<Link
									to="/"
									href="/home"
									className="block text-sm text-gray-400 hover:text-indigo-400 transition duration-150"
								>
									Home
								</Link>
								<Link
							...
							<address className="space-y-3 not-italic text-sm">
								<div className="flex items-center">
									...
									<a
										...
										className="text-gray-400 hover:text-indigo-400 transition duration-150 break-all"
									>
						...
						<div>
							...
							<div className="flex flex-wrap gap-3">
								<div className="w-12 h-8 bg-white rounded-md flex items-center justify-center shadow-lg">
					...
					<div className="border-t border-gray-800 mt-8 pt-6 pb-6 text-center">
